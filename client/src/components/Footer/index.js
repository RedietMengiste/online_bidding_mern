        ...
        <div className={"container"}>
          <div className={"newslater-area row"}>
            <div className={"col-lg-4"}>
              <img
                src="assets/images/footer/login.svg"
                width="250px"
                alt="footer"
              />
              <h4
            ...
            <div className={"col-lg-4"}>
              <img
                src="assets/images/footer/view.svg"
                width="250px"
                alt="footer"
              />
              <h4
            ...
            <div className={"col-lg-4"}>
              <img
                src="assets/images/footer/buy.svg"
                width="250px"
                alt="footer"
              />
              <h4
          ...
          <div className={"row mb--60"}>
            ...
            <div className={"col-sm-6 col-lg-3"}>
              <div className={"footer-widget widget-links"}>
                ...
                <ul className={"links-list"}>
                  <li>
                    <Link to="/about">About E-Gebeya</Link>
                  </li>
                  <li>
            ...
            <div className={"col-sm-6 col-lg-3"}>
              <div className={"footer-widget widget-follow"}>
                ...
                <ul className={"links-list"}>
                  <li>
                    <a href="#0">
                      <i className={"fas fa-phone-alt"}></i>+(251)946414257
                    </a>
                  </li>
                  <li>
                    <a href="#0">
                      <i className={"fas fa-blender-phone"}></i>+(251)915734626
                    </a>
                  </li>
                  <li>
                    <a href="#0">
                  ...
                  <li>
                    <a href="#0">
                      <i className={"fas fa-map-marker-alt"}></i>Lideta, A.A,
                      Ethiopia.
                    </a>
                  </li>
                </ul>
          ...
          <div className={"copyright-area"}>
            <div className={"footer-bottom-wrapper"}>
              ...
              <div className={"copyright"}>
                <p>
                  &copy; Copyright 2021 | <Link to="/">E-Gebeya</Link>
                </p>
              </div>
            </div>
          </div>
