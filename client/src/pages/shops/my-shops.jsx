...
import {fetchAllShopsSuccessAsync, fetchShopsByOwnerSuccessAsync, fetchShopSuccessAsync} from "../../store/shop/action"
...
export const MyShopPage = () => {
    ...
    useEffect(() => {
       dispatch(fetchShopsByOwnerSuccessAsync(page, limit))
    }, [])
                ...
                <section className={"featured-auction-section padding-bottom mt--240 mt-lg--440 pos-rel"}>
                    <div className={"container"}>
                        <div className={"section-header cl-white mw-100 left-style"}>
                            <h3 className={"title"}>My Shops</h3>
                        </div>
                        <div className={"row justify-content-center mb-30-none"}>

                        
                        {
                            shops.slice(shops.length > 3 ? shops.length - 3:shops.length).map((shop)=>{
                               return <div className={"col-sm-10 col-md-6 col-lg-4"}>
                                    <div className={"auction-item-2"}>
                                            <div className={"auction-thumb"}>
                                                <Link ><img src={`${process.env.REACT_APP_SHOP_IMG_URL}/${shop.image}`} alt={shop.name}/></Link>
                                                <Link to={"/shop/edit/"+shop._id} class="bid"><i class="flaticon-edit"></i></Link>
                                            ...
                                            <div className={"auction-content"}>
                                                ...
                                                <div className={"countdown-area"}>
                                                    ...
                                                    <Link>
                                                        <span className={"total-bids"}>{shop.owner.firstName + shop.owner.lastName}</span>
                                                    </Link>
                                                </div>
                                                <div className={"text-center"}>
                                                    <Link to={"/products/"+shop._id} className={"custom-button"}>See Products</Link>
                                                </div>
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <div className={"auction-item-2"}>
                                            ...
                                            <div className={"auction-content"}>
                                                ...
                                                <div className={"countdown-area"}>
                                                    ...
                                                    <Link>
                                                        <span className={""}>{shop.owner.firstName + shop.owner.lastName}</span>
                                                    </Link>
                                                </div>
                                                <div className={"text-center"}>
                                                    <Link to={"/products/"+shop._id} className={"custom-button"}>See Products</Link>
