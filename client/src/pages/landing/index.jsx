...
export const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className={"browse-slider-section mt--140"}>
        <div className={"container"}>
          <div className={"section-header-2 cl-white mb-4"}>
            <div className={"left"}>
              <h6 className={"title pl-0 w-100"}>
                Our most common categories{" "}
                <i className={"fas fa-arrow-down"}></i>
              </h6>
            </div>
            <div className={"slider-nav"}>
              <a href="#" className={"bro-prev"}>
                <i className={"flaticon-left-arrow"}></i>
              </a>
              <a href="#" className={"bro-next active"}>
      ...
      <section
        className={"real-estate-auction padding-top padding-bottom pos-rel oh"}
      >
        ...
        <div className={"container"}>
          <div className={"section-header-3"}>
            ...
            <Link to="/auctions" className={"normal-button"}>
              View All
            </Link>
          </div>
          <div className={"auction-slider-4 owl-theme owl-carousel"}>
            <div className={"auction-item-4"}>
              ...
              <div className={"auction-content"}>
                <h4 className={"title"}>
                  <a href="product-details.html">
                    Abenezer real state, Addis Ababa
                  </a>
                </h4>
                <div className={"bid-area"}>
                  <div className={"bid-amount"}>
                    ...
                    <div className={"amount-content"}>
                      ...
                      <div className={"amount"}>2,000,000 Birr</div>
                    </div>
                  </div>
                  <div className={"bid-amount"}>
                    <div className={"icon"}>
                    ...
                    <div className={"amount-content"}>
                      ...
                      <div className={"amount"}>2,300,000.00 Birr</div>
                    </div>
                  </div>
                </div>
                ...
                <div className={"text-center"}>
                  <a href="/auctions" className={"custom-button"}>
                    Submit a bid
                  </a>
                </div>
              </div>
            ...
            <div className={"auction-item-4"}>
              ...
              <div className={"auction-content"}>
                <h4 className={"title"}>
                  <a href="product-details.html">
                    Brand New Apartments In Addis Ababa
                  </a>
                </h4>
                <div className={"bid-area"}>
                  <div className={"bid-amount"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Current Bid</div>
                      <div className={"amount"}>876,000.00 Birr</div>
                    </div>
                  </div>
                  <div className={"bid-amount"}>
                    <div className={"icon"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Buy Now</div>
                      <div className={"amount"}>5,000,000.00 Birr</div>
                    </div>
                  </div>
                </div>
                <div className={"countdown-area"}>
              ...
              <div className={"auction-content"}>
                ...
                <div className={"bid-area"}>
                  <div className={"bid-amount"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Current Bid</div>
                      <div className={"amount"}>830,000.00 Birr</div>
                    </div>
                  </div>
                  <div className={"bid-amount"}>
                    <div className={"icon"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Buy Now</div>
                      <div className={"amount"}>1,000,000.00 Birr</div>
                    </div>
                  </div>
                </div>
                <div className={"countdown-area"}>
              ...
              <div className={"auction-content"}>
                ...
                <div className={"bid-area"}>
                  <div className={"bid-amount"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Current Bid</div>
                      <div className={"amount"}>81,000.00 Birr</div>
                    </div>
                  </div>
                  <div className={"bid-amount"}>
                    <div className={"icon"}>
                    ...
                    <div className={"amount-content"}>
                      <div className={"current"}>Buy Now</div>
                      <div className={"amount"}>500,000.00 Birr</div>
                    </div>
                  </div>
                </div>
                <div className={"countdown-area"}>
