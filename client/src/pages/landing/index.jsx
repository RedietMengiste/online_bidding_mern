...
export const LandingPage = () => {
    ...
    return (
        <>
            <Navbar/>
            <section className={"banner-section bg_img"} data-background="assets/images/banner/banner-bg-1.png" style={{backgroundImage :'url(http://pixner.net/sbidu/main/assets/images/banner/banner-bg-1.png)'}}>
