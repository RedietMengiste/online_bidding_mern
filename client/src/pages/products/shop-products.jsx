...
import {fetchAllProductsSuccessAsync, fetchProductsByShopSuccessAsync, fetchProductSuccessAsync} from "../../store/product/action"
...
export const ShopProducts = () => {
    ...
    return(
        <>
            ...
            <div className={"hero-section style-2"}>
                <div className={"container"}>
                    <ul className={"breadcrumb"}>
                        ...
                        <li>
                            <span>Products of {products.length>0?products[0].shop.name:"Shop"}</span>
                        </li>
                    </ul>
                    {
                        user.seller && (
                ...
                <section className={"featured-auction-section padding-bottom mt--240 mt-lg--440 pos-rel"}>
                    <div className={"container"}>
                        <div className={"section-header cl-white mw-100 left-style"}>
                            <h3 className={"title"}>Latest Products of {products.length>0?products[0].shop.name:"Shop"}</h3>
                        </div>
                                    ...
                                    <div className={"auction-item-2"}>
                                            ...
                                            <div className={"auction-content"}>
                                                ...
                                                <div className={"text-center"}>
                                                    <Link to='/products' className={"custom-button"}>See Product Detail</Link>
                                                </div>
                                            </div>
                                        </div>
                                </div>
            ...
            {/*  list of products*/}
            {
                (products.length > 0)&&(<div className={"product-auction padding-bottom"}>
                <div className={"container"}>
                               ...
                               return <div className={"col-sm-10 col-md-6 col-lg-4"}>
                                    <div className={"auction-item-2"}>
                                            ...
                                            <div className={"auction-content"}>
                                                ...
                                                <div className={"text-center"}>
                                                    <a href="#0" className={"custom-button"}>See Product Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                </div>
